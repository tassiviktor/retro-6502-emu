...
/**
 * Represents a flag which can be set or waited for - once signalled, things waiting for it doesn't block
 * Created by Ashley Frieze https://github.com/webcompere/signal
 */
public class Signal {
